      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 -mt-16">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 bg-white rounded-3xl shadow-xl shadow-gray-200/50 p-10 border border-gray-100 flex flex-col justify-center">
            <div className="mb-10">
              ...
              <p className="text-primary font-semibold text-lg uppercase tracking-wide font-secondary">Senior Secondary School</p>
            </div>
              ...
              <div className="flex gap-5">
                ...
                <div>
                  ...
                  <p className="text-gray-600 leading-relaxed text-sm font-secondary">
                   Vels Vidyashram Kindergarten,<br/>
                   1 / 54, Officers Lane, Cantonment,<br/>
                   Pallavaram, Chennai - 600 043, Tamil Nadu
              ...
              <div className="space-y-8">
                ...
                <div className="flex gap-5">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm font-medium break-all font-secondary">inquiries@velsvidyashram.ac.in</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="mt-12 mb-20 relative group">
          ...
          <div className="overflow-hidden rounded-[2.5rem] shadow-2xl border-8 border-white">
            <iframe 
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3888.0409063118286!2d80.1502144!3d12.9692343!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a525f10e37ab011%3A0xa6dbd27c3cb1cff5!2sPallavaram%20Bus%20Stand!5e0!3m2!1sen!2sin!4v1775195594168!5m2!1sen!2sin" 
              width="100%" 
              height="550" 
              style={{ border: 0 }} 
              allowFullScreen="" 
