  ...
  videosByYear: {
    "2026 - 2027": [
      ...
      // },
      {
        ...
        videoUrl: "https://www.youtube.com/embed/FHb17y_GxEY?si=-nf0ft7JXXJthJgK"
      },
      {
        id: 7,
        title: "New parent orientation",
        thumbnail: "/thalambur/thumbnail/New-parent-orientation.jpg",
        videoUrl: "https://www.youtube.com/embed/zu6YCcI6JWA?si=8s-3Apt6M74QG6Fe"
      },
      {
        id: 8,
        ...
        videoUrl: "https://www.youtube.com/embed/JH6H58uppzA?si=HfQYbAEItiwZcoXp"
      },
      {
        id: 9,
        title: "Father's Day celebration",
        thumbnail: "/thalambur/thumbnail/Fathers-Day-celebration.jpg",
        videoUrl: "https://www.youtube.com/embed/MoKiSC7EZng?si=YFnyCML9j1MTu7mF"
      },
      
      {
        ...
        videoUrl: "https://www.youtube.com/embed/btKTP84_E9Y?si=M7SwP36xH3yUkzF1"
      },
    ],
    "2025 - 2026": [
      {
  ...
  const popup =
    mounted && selectedVideo
      ? createPortal(
          <AnimatePresence>
            <motion.div
              className="fixed inset-0 z-[2147483647] bg-black/80 backdrop-blur-xl flex items-center justify-center p-4"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              exit={{ opacity: 0 }}
              onClick={closeVideo}
            >
              <motion.div
                ...
                className="relative w-[94vw] md:w-[75vw] lg:w-[58vw] xl:w-[48vw] max-w-4xl bg-white rounded-2xl shadow-2xl overflow-hidden z-[2147483647]"
              >
                <div className="w-full h-[250px] md:h-[360px] lg:h-[440px] bg-black">
                  <iframe
                ...
                <button
                  onClick={closeVideo}
                  className="absolute top-3 right-3 bg-black text-white rounded-full p-2 z-[2147483647]"
