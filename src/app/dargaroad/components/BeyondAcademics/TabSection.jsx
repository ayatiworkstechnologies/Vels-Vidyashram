...
const CONTENT = {
  Activities: {
    ...
    items: [
      ...
      },
      {
        heading: "Project",
        paragraphs: [
          "Project work is an integral part of the school curriculum which is held class wise to bring out the aesthetic and latent potential of every student. Projects build team spirit, leadership qualities, conflict resolving skills and creativity among the students.",
        ],
      },
      {
      ...
      },
      {
        ...
        paragraphs: [
          "A sound mind in a sound body.’ This is ensured by making games compulsory for all students. Professionally qualified Physical Education Teachers take care of the sports activities of the school.",
    ...
    testimonials: [
      {
        ...
        text: "Basic foot steps like Thattadavu, Nattadavu, MardhithaAdavu, Korvai etc., and the slokas accompanying the movements of hands and body are taught to the beginners. At an advanced stage the learners are taught items like Pushpanjali, Alarippu, Jathiswaram etc.",
      },
      {
        title: "Yoga",
        text: "Exercises and postures that benefit different parts of the body are demonstrated and performed. Asanas are graded according to the age and experience of the student.",
      },
      {
      ...
      },
      {
        ...
        text: "This nurtures creativity and paves the way for strengthening problem-solving techniques. The inventive faculty coupled with divergent thinking make children, visionaries.",
      },
      {
        title: "General Assembly",
        text: "The general assembly is a weekly feature offering varied activities and serves as a stage for students, aspiring to compete at higher levels.",
      },
      {
        title: "Vocal Music",
        text: "Carnatic Music is taught in a graded syllabus in order to preserve, nurture and promote our rich heritage that has come to us as a legacy. Krithis and Bhajans of famous composers in different languages are also introduced.",
      },
    ],
  },
  ...
  "Cultural and Sports Academy": {
    ...
    intro: [
      ...
      "The students are grouped according to their level of skill and individual training is given to the students.",
      "The following classes offer opportunities to children to explore new areas and satisfy their needs and develop their interests.",
    ],
    listLeft: [
      "Bharatha Natyam",
...
export default function ActivitiesSection() {
  ...
  /* ---------- AUTO SCROLL (ONLY GENERIC CONTENT) ---------- */
  useEffect(() => {
              ...
              <div className="mt-3">
                <div
                  className={`h-[1px] w-20 ${
                    i === activeIndex ? "bg-secondary" : "bg-secondary"
                  }`}
                />
              </div>
            </button>
            ...
            <>
              ...
              <div className="grid md:grid-cols-2 gap-12 bg-white p-10 ">
                <div className="relative h-[360px] sticky top-24 overflow-hidden">
                  <Image src={data.image} alt={data.title} fill className="" />
                </div>
                ...
                >
                  ...
                  {data.intro &&
                    data.intro.map((p, i) => (
                      <p
                        key={i}
                        className="text-md font-secondary font-secondary-regular text-black mb-3 leading-relaxed"
                      >
                        {p}
                      </p>
                    ))}
                        ...
                        <button
                          onClick={() =>
                            setTestimonialIndex((i) =>
                              Math.min(i + 1, data.testimonials.length - 3)
                            )
                          }
                          disabled={
                            testimonialIndex >= data.testimonials.length - 3
                          }
                          className="disabled:opacity-30"
                        >
                          ›
