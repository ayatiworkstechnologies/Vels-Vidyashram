  ...
  awards: [
    {
      title: "Karate",
      id: 1,
      images: ["/thalambur/karate-1.jpg", "/thalambur/karate-2.jpg"],
    },
    {
      title: "Archery",
      category: "Science",
      id: 2,
      images: ["/thalambur/archery-1.jpg", "/thalambur/archery-2.jpg"],
    },
    {
      title: "SOF and IOF Gold Medal winners",
      category: "Sports",
      id: 3,
      images: ["/thalambur/sof.jpg"],
    },
    {
      title: "Swimming Competition",
      category: "Excellence",
      id: 4,
      images: ["/thalambur/vv-1.jpg", "/thalambur/vv-2.jpg"],
    },
    {
      title: "Singhania Leadership Conference",
      category: "Academic",
      id: 5,
      images: ["/thalambur/singh.jpg"],
    },
    {
      title:
        "Prithun Prasath of Grade 3 won silver medal in Skating which was conducted by Decathlon.",
      category: "Technology",
      id: 6,
      images: ["/thalambur/p-1.jpg", "/thalambur/p-2.jpg"],
    },
    {
      title:
        "Sangamithrai of grade 3 for performing Silambam continuously for 3 hours",
      id: 7,
      images: ["/thalambur/san.jpg"],
    },
    {
      title:
        "Sai Sree Rohit- placed 3rd in chengalpat district level chess competition",
      category: "Arts",
      id: 8,
      images: [
    ...
    {
      title:
        "Lakshana G of VVT who is placed 1st in chengalpat district level chess competition",
      category: "Arts",
      id: 9,
      images: [
    ...
    {
      title:
        "𝑬𝒙𝒄𝒆𝒍𝒍𝒆𝒏𝒄𝒆 𝒊𝒏 𝑬𝒅𝒖-𝑺𝒑𝒐𝒓𝒕𝒔 𝒂𝒏𝒅 𝑺𝒐𝒄𝒊𝒂𝒍 𝑽𝒂𝒍𝒖𝒆 𝑬𝒅𝒖𝒄𝒂𝒕𝒊𝒐𝒏",
      category: "Arts",
      id: 13,
      images: [
        "/thalambur/ex-1.jpg",
      ...
      setCarouselStates((prev) => {
        ...
        Object.keys(newStates).forEach((key) => {
          ...
          if (award && award.images.length > 1) {
            newStates[key] = (newStates[key] + 1) % award.images.length;
          }
        });
    ...
    setCarouselStates((prev) => {
      ...
      const newIndex =
        direction === "next"
          ...
          : (currentIndex - 1 + award.images.length) % award.images.length;
  ...
  const lightbox =
    mounted && selectedIndex !== null
      ? createPortal(
          <AnimatePresence>
            <motion.div
              className="fixed inset-0 bg-black/95 z-[2147483647] flex flex-col items-center justify-center p-4 md:p-6"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              exit={{ opacity: 0 }}
            ...
            >
              <button
                onClick={closeLightbox}
                className="fixed top-5 right-5 text-white z-[2147483647] bg-white/10 hover:bg-white/20 p-2 rounded-full"
                aria-label="Close"
              >
                <X size={30} />
              </button>
              ...
              {activeImages.length > 1 && (
                <>
                  <button
                    onClick={handlePrev}
                    className="fixed left-4 md:left-8 top-1/2 -translate-y-1/2 text-white bg-white/10 hover:bg-white/20 p-3 rounded-full z-[2147483647]"
                  ...
                  <button
                    onClick={handleNext}
                    className="fixed right-4 md:right-8 top-1/2 -translate-y-1/2 text-white bg-white/10 hover:bg-white/20 p-3 rounded-full z-[2147483647]"
              ...
              <div
                className="w-full max-w-6xl h-[68vh] flex items-center justify-center"
              ...
              {activeImages.length > 1 && (
                <div
                  className="flex gap-3 mt-6 overflow-x-auto max-w-5xl w-full pb-2"
                  onClick={(e) => e.stopPropagation()}
                >
