...
const onSubmit = async (formData) => {
  try {
    ...
    const response = await fetch(
      "https://api.ayatiworks.com/api/v1/public/vels-dargaroad/recruitment/records", // 🔥 changed endpoint
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          "X-API-Key": "f118c8833be5d3de313be7a6516abf706eae47426e4f5857e43d61db7989bc0e",
        },
