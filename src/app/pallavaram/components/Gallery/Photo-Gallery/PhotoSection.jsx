...
const INFRA_DATA = {
  ...
  images: [
    { id: 1, span: "md:col-span-6 md:row-span-1", src: "/pallavaram/in-1.png" },
    { id: 2, span: "md:col-span-3", src: "/pallavaram/in-2.png" },
    { id: 3, span: "md:col-span-3", src: "/pallavaram/in-3.png" },
    { id: 4, span: "md:col-span-3", src: "/pallavaram/in-4.png" },
    { id: 5, span: "md:col-span-3", src: "/pallavaram/in-5.png" },
    { id: 6, span: "md:col-span-3", src: "/pallavaram/in-6.png" },
    { id: 7, span: "md:col-span-3", src: "/pallavaram/in-7.png" },
