        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-10 items-start">
          ...
          <div>
            ...
            <div className="mt-6 space-y-3 text-[15px]">
              ...
              <p>
                ...
                <a href="mailto:register@velsvidyashram.ac.in">
          ...
          <div>
            ...
            <ul className="space-y-1 text-[15px] list-disc pl-5 marker:text-white">
              <li>
                <Link href="/pallavaram">Home</Link>
              </li>

              <li>
                <Link href="/pallavaram/our-group">Our Group</Link>
              </li>

              <li>
                <Link href="/pallavaram/curriculum">Academics</Link>
              </li>
              ...
              <li>
                <Link href="/pallavaram/contact-us">Contact Us</Link>
              </li>

              <li>
                <Link href="/pallavaram/recruitment">
                  Job Openings @ Vels
                </Link>
              </li>
          ...
          <div>
            ...
            <div className="overflow-hidden rounded-[14px] shadow-md">
              <iframe
                ...
                title="Vels Vidyashram Pallavaram Campus Location"
              />
            </div>
          </div>
