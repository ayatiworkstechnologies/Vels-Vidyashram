        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-10 items-start">
          ...
          <div>
            ...
            <p className="text-[15px] leading-[1.8] text-white/95">
              ...
              <br />
              P.V.Vaithiyalingam Road , Velan Nagar
              <br />
            ...
            <div className="mt-6 space-y-3 text-[15px]">
              <p>
                ...
                <a href="tel:+917401657975" className="">782 483 0871</a>
               
              </p>
              <p>
                <span className="font-bold">Mail:</span>{' '}
                <a href="mailto:register@velsvidyashram.ac.in" className="">
          ...
          <div>
            ...
            <ul className="space-y-1 text-[15px] list-disc pl-5 marker:text-white">
              <li><Link href="/pallavaram" className="">Home</Link></li>
              <li><Link href="/pallavaram/our-group" className="">Our Group</Link></li>
              <li><Link href="/pallavaram/curriculum" className="">Academics</Link></li>
              ...
              <li><Link href="/pallavaram/contact-us" className="">Contact us</Link></li>
              <li><Link href="/pallavaram/recruitment" className="">Job Openings @ Vels</Link></li>
              <li><Link href="/pallavaram/mandatory-disclosure" className="">Mandatory Disclosure</Link></li>
            </ul>
          </div>
