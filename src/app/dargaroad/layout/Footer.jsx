    ...
    <footer className="w-full mt-10 pb-[45px] md:pb-0">
      ...
      <div className="bg-[#F5F5F5] py-6">
        ...
        <div className="flex flex-wrap justify-center gap-15 text-sm font-primary font-primary-semibold text-black mb-4">
          <a href="/dargaroad/curriculum" className="hover:text-primary transition">Academics</a>
          ...
          <a href="/dargaroad/our-group" className="hover:text-primary transition">Our Group</a>
          <a href="/dargaroad/mandatory-disclosure" className="hover:text-primary transition">Mandatory Disclosure</a>
        </div>
