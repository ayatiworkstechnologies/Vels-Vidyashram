...
const CircularSection = () => {
  ...
  const reports = [
    { month: 'Circular 1', link: '/pallavaram/circular/CIRCULAR-1-1.pdf' },
    { month: 'Circular 2', link: '/pallavaram/circular/CIRCULAR-2.pdf' },
    { month: 'Circular 3', link: '/pallavaram/circular/CIRCULAR-3.pdf' },
    { month: 'Circular 4', link: '/pallavaram/circular/CIRCULAR-4.pdf' },
    { month: 'Circular 5', link: '/pallavaram/circular/CIRCULAR-5.pdf' },
    { month: 'Circular 6', link: '/pallavaram/circular/circular-6.pdf' },
    { month: 'Circular 7', link: '/pallavaram/circular/CIRCULAR-7.pdf' },
     { month: 'Circular 8', link: '/pallavaram/circular/circular-8.pdf' },
  ];
