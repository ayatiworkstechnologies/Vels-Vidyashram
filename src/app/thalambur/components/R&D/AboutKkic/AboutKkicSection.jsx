    ...
    <section className="bg-white py-20 px-6 md:px-12 lg:px-24 text-slate-800">
      <div className="max-w-6xl mx-auto">
        ...
        <motion.div {...fadeInUp} className="mb-16 border-b border-slate-100 pb-10">
          <h1 className="text-4xl md:text-5xl font-black text-indigo-950 mb-8 tracking-tight uppercase">
            ABOUT KKIC
          </h1>
          <p className="text-xl leading-relaxed text-slate-600 max-w-5xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          >
            <h2 className="text-2xl md:text-3xl font-extrabold text-indigo-900 mb-6 leading-tight">
              KINDLEKIDS INTERNATIONAL CURRICULUM ( KKIC )
            </h2>
            <p className="text-lg leading-relaxed text-indigo-950/80 mb-6">
