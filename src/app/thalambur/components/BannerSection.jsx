...
const slides = [
  ...
  },
  {
    ...
    image: "/thalambur/banner/banner-3.jpg",
    mobileImage: "/thalambur/banner/3.png",
  },
  {
    title: "Beyond Academics",
    subtitle: "Developing Talents\nIn Sports and Arts",
    image: "/thalambur/banner/banner-4.jpg",
    mobileImage: "/thalambur/banner/4.png",
  },
  {
    title: "Vels Group",
    subtitle: "Legacy of 30+ Years\nin Quality Education",
    image: "/thalambur/banner/banner-5.jpg",
    mobileImage: "/thalambur/banner/5.png",
  },
  {
    title: "Digital Learning",
    subtitle: "Smart Classrooms\nfor the Future Leaders",
    image: "/thalambur/banner/banner-6.jpg",
    mobileImage: "/thalambur/banner/6.png",
  },
  {
    title: "Our Pride",
    subtitle: "Vels Vidyashram\nCantonment & Thalambur",
    image: "/thalambur/banner/banner-7.jpg",
    mobileImage: "/thalambur/banner/7.png",
  },
];
      ...
      <div className="absolute inset-0 z-0">
        {slides.map((s, i) => (
          ...
          >
            ...
            <div className="absolute inset-0 hidden md:block bg-gradient-to-r from-black/70 via-black/20 to-transparent lg:from-black/70 lg:via-black/20" />
