    ...
    <>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto p-8">
        {cards.map((card, index) => (
          <div
            key={card.id}
            className={`group relative bg-gradient-to-br from-white to-gray-50 rounded-2xl shadow-lg p-8 cursor-pointer transition-all duration-500 border border-gray-200 hover:border-blue-400 overflow-hidden ${
              activeCard === card.id
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <div
                className={`relative w-12 h-12 mx-auto mb-6 transition-all duration-500 ${
                  activeCard === card.id
                    ? "animate-bounce-gentle scale-110"
              ...
              <p
                className={`text-gray-600 text-center leading-relaxed transition-all duration-500 ${
                  activeCard === card.id
            ...
            <div
              className={`absolute inset-0 bg-gradient-to-r from-transparent via-white/30 to-transparent skew-x-12 transition-all duration-700 ${
