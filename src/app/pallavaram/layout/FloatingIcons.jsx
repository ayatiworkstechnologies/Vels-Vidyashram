...
const FloatingActions = () => {
  const socialLinks = [
    {
      ...
      href: "https://www.facebook.com/people/VELS-Vidyashram-Pallavaram/100064089751428/#",
      color: "text-[#1877F2]",
      label: "Facebook"
    },
    {
      icon: <Instagram size={20} />,
      href: "https://www.instagram.com/accounts/login/?next=%2Fvelsvidyashrampallavaram%2F&source=omni_redirect",
      color: "text-[#E4405F]",
      label: "Instagram"
    },
    {
      ...
      href: "https://api.whatsapp.com/send?phone=+917824830871",
      color: "text-[#25D366]",
      label: "WhatsApp"
    },
    {
      icon: <Youtube size={20} />,
      href: "https://www.youtube.com/channel/UCJzj41SIGjeYgbbs1lWFDpA?view_as=subscriber",
      color: "text-[#FF0000]",
      label: "YouTube"
    },
    {
  ...
  return (
    <>
      ...
      {/* ── MOBILE: Fixed bottom footer bar (hidden on desktop) ── */}
      <div className="flex md:hidden fixed bottom-0 left-0 right-0 z-[9999] bg-white border-t border-gray-200 shadow-[0_-4px_20px_rgb(0,0,0,0.10)]">

        {/* Admissions CTA — takes up left portion */}
        <a
          href="https://erp.vistas.ac.in/velsonline/applicationschools/loginManager/applicantRegistrationVVS.jsp"
          target="_blank"
          rel="noopener noreferrer"
          className="relative flex items-center justify-center gap-2 bg-orange-500 text-white font-bold text-sm px-4 py-3 flex-shrink-0 overflow-hidden"
        ...
        {/* Social Icons — fill remaining width evenly */}
        <div className="flex items-center justify-around flex-1 px-1">
          {socialLinks.map((social, index) => (
            <a
              ...
              className={`flex items-center justify-center p-3 active:scale-90 transition-transform duration-150 ${social.color}`}
            >
              {social.icon}
            </a>
          ))}
