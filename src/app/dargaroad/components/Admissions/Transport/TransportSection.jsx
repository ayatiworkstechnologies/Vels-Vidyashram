...
const routes = [
  "Alandur, Near Abambakkam", "Nanganallur, Madipakkam", "Keelkatalai, S.Kolathur", "Pallikaranai, Perumbakkam", "Sembakkam, Santhoshapuram,Vengaivasal",
  "East Tambaram, Mappedu", " Old Perungalathur, Manivakkam", " Chrompet, Thirumudivakkam", "Pammal, Kundrathur", "Pammal, Pozhichalur",
  "Radha nagar, Chittlapakkam", "Hasthinapuram, Nanmangalam", "Vadakupattu, Medavakkam", "West tambaram, Old perungalathur", "Keelkatalai,Sunnabhu kolathur", "Pammal, Aanagaputhur",
];
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <div className="flex justify-center gap-8 pt-4 font-secondary">
            ...
            <div className="flex items-center gap-2 text-sm font-semibold text-gray-800">
              <Users className="text-primary" size={20} /> Van Assistants - Contact  Mr. Satish Kumar +91 9962506235
            </div>
          </div>
        </motion.div>
