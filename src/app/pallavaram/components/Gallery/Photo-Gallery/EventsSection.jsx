  ...
  eventsByYear: {
    "2025-2026": [
      ...
      },
      {
        ...
        id: 9,
        size: "small",
        images: ["/pallavaram/events/central.jpeg"],
      },
      {
        title: "Sports Day",
        id: 10,
    ...
    "2024-2025": [
      {
        ...
        id: 101,
        size: "large",
        images: ["/thalambur/parent-1.jpg", "/thalambur/parent-2.jpg"],
      },
      {
      ...
      ? createPortal(
          <AnimatePresence>
            ...
            >
              <button
                onClick={closeLightbox}
                className="fixed top-4 right-4 md:top-8 md:right-8 text-white/80 hover:text-white bg-white/10 hover:bg-white/20 rounded-full p-3 transition-colors"
                style={{ zIndex: 2147483647 }}
                aria-label="Close"
              >
                <X size={32} />
              ...
              >
                {activeEventImages.length > 1 && (
                  <button
                    ...
                    className="hidden md:flex fixed left-8 top-1/2 -translate-y-1/2 text-white/70 hover:text-white bg-white/10 hover:bg-white/20 rounded-full p-3"
                    style={{ zIndex: 2147483647 }}
                  >
                    <ChevronLeft size={48} />
                  </button>
                ...
                {activeEventImages.length > 1 && (
                  <button
                    ...
                    className="hidden md:flex fixed right-8 top-1/2 -translate-y-1/2 text-white/70 hover:text-white bg-white/10 hover:bg-white/20 rounded-full p-3"
                    style={{ zIndex: 2147483647 }}
                  >
            ...
            return (
              ...
              >
                <div className="relative h-full w-full">
                  <motion.img
                    key={`${selectedYear}-${event.id}-${currentIndex}`}
                    initial={{ opacity: 0.8 }}
                    animate={{ opacity: 1 }}
                    src={currentImage}
