      ...
      >
        ...
        <div className="overflow-y-auto flex-1">
          ...
          <div className="p-6 mt-4 border-t bg-gray-50 space-y-3">
            ...
            <a href="tel:9962506639" className="flex items-center gap-3 text-sm text-gray-700">
              <img src="/thalambur/phone.png" className="w-4 opacity-70" alt="" />
              99625 06639
            </a>

            <a href="mailto:apply@velsvidyashram.ac.in" className="flex items-center gap-3 text-sm text-gray-700">
