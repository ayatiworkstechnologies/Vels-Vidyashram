...
const ITEMS = [
  { id: 1, title: "Mandatory Disclosure", icon: "/dargaroad/pdf/mandatory-disclosure.png", pdf: "/dargaroad/pdf/Mandatory-disclosure.pdf" },
  { id: 2, title: "Affiliations", icon: "/dargaroad/pdf/affliation.png", pdf: "/dargaroad/pdf/AFFILIATION.pdf" },
  { id: 3, title: "NOC", icon: "/dargaroad/pdf/noc.png", pdf: "/dargaroad/pdf/NOC.pdf" },
  { id: 4, title: "Trust", icon: "/dargaroad/pdf/trust.png", pdf: "/dargaroad/pdf/TRUST.pdf" },
  { id: 5, title: "Building", icon: "/dargaroad/pdf/building.png", pdf: "/dargaroad/pdf/Building.pdf" },
  { id: 6, title: "Fire", icon: "/dargaroad/pdf/fire.png", pdf: "/dargaroad/pdf/fire-certificate.pdf" },
  { id: 7, title: "Sanitary", icon: "/dargaroad/pdf/sanitary.png", pdf: "/dargaroad/pdf/sanitary-certificate.pdf" },
  { id: 8, title: "FEE structure", icon: "/dargaroad/pdf/fee-structure.png", pdf: "/dargaroad/pdf/fee-structure.pdf" },
  { id: 9, title: "Calendar", icon: "/dargaroad/pdf/calendar.png", pdf: "/dargaroad/pdf/academic-calendar.pdf" },
  { id: 10, title: "SMC", icon: "/dargaroad/pdf/smc.png", pdf: "/dargaroad/pdf/Smc.pdf" },
  { id: 11, title: "Recognition", icon: "/dargaroad/pdf/recognition.png", pdf: "/dargaroad/pdf/Recognition.pdf" },
