      ...
      <div className="absolute inset-0 z-0">
        {slides.map((s, i) => (
          ...
          >
            ...
            {/* GRADIENT OVERLAY: This is the key to showing the image while keeping text readable */}
