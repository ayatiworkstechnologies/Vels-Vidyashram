...
const activities = [
  ...
  },
  {
    ...
    images: ["/pallavaram/events/robot-1.jpg", "/pallavaram/events/robot-2.jpg", "/pallavaram/events/robot-3.jpg", "/pallavaram/events/robot-4.jpg"],
    color: "bg-slate-50"
  },
];
...
export default function BeyondAcademics() {
  return (
    <div className="bg-white relative z-0">
      {/* Hero Header */}
      <div className="h-[40vh] flex flex-col items-center justify-center text-center px-4 relative z-10 bg-white">
