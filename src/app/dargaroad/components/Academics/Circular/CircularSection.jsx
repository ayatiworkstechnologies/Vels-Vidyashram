...
const CircularSection = () => {
  ...
  const reports = [
    { month: 'Circular 1', link: '/dargaroad/pdf/circular-1.pdf' },
    { month: 'Circular 2', link: '/dargaroad/pdf/circular-2.pdf' },
    { month: 'Circular 3', link: '/dargaroad/pdf/circular-3.pdf' },
