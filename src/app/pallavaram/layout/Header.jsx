        ...
        <div className="max-w-7xl mx-auto px-4 py-2 sm:py-3 flex items-center justify-between">
          ...
          <div className="flex items-center justify-between w-full md:w-auto gap-2 sm:gap-4">
            ...
            <div className="relative group hidden lg:block">
              <button className="bg-white text-[#2B158F] px-3 sm:px-4 py-1.5 rounded-full font-bold text-[10px] sm:text-xs whitespace-nowrap hover:bg-gray-100 transition shadow-sm">
                Other Campus
              </button>
