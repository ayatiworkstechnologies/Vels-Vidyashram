          ...
          <div className="grid grid-cols-1 gap-x-12 gap-y-5 md:grid-cols-2">
            ...
            <div className="space-y-1.5">
              ...
              <textarea
                ...
                className={`w-full min-h-[100px] border p-2.5 text-[13px] outline-none ${
            ...
            <div className="md:col-span-1 space-y-1.5">
              ...
              <input
                ...
                className={`w-full border p-1.5 text-[12px] file:mr-4 file:border-0 file:bg-gray-100 file:px-3 file:py-1 file:text-[12px] ${
