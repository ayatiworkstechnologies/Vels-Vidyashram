  ...
  const cards = [
    {
      ...
      title: "Vision",
      text: "The best CBSE School in Thalambur, Chennai that ensures a holistic development of all the students and empowers them to embrace learning to achieve their personal best and build their emotional, social and physical well-being.",
    },
    {
      id: "mission",
